...
class ImageGenerationService {
  // Spiritual guru images for quotes (using local uploaded images)
  ...
  async generateQuoteImage(options: ShareImageOptions): Promise<any> {
    const { quote } = options;

    // Return mock image asset based on quote ID for consistency
